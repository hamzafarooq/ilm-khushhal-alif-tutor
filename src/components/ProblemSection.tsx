      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-blue-500 hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">No Internet Access</h3>
            <p className="text-gray-600">
              Limited internet connectivity prevents students from accessing 
              online educational resources and modern learning tools.
            </p>
          </div>
        </div>
